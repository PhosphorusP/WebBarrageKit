...
<body id="body">
		<form action="<?php file_put_contents("test.txt",strtr($_POST["temp"], array(' '=>'')),FILE_APPEND);if(strtr($_POST["temp"], array(' '=>'')))file_put_contents("test.txt"," ",FILE_APPEND); ?>" method="post" id="sendbarrage">
